...
def calc(function, input_num, target):
    global counter
    ...
    calc(right_func, output_num, target)
    calc(left_func, output_num, target)
...
def resolve(data):
    ...
    calc(right_func, input_num, target)
    calc(left_func, input_num, target)
